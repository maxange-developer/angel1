...
const SVG = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 630">
  ...
  <text x="600" y="430" font-family="Inter, system-ui, sans-serif" font-weight="400" font-size="28" fill="#9d9d9d" text-anchor="middle" letter-spacing="1">AI-Enhanced MVP Developer · Tenerife</text>
</svg>`;
